---
skill: scientia-grill-proposal
---

# Rubric: scientia-grill-proposal

## Setup

Take the proposal produced by the `scientia-seed-proposal` eval and a wiki that contains
...
`scientia-grill-proposal`. Save the produced `grill.md` to `output.md` here.
