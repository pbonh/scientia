...
#   3. (optional) a SOUL.md persona + <name>.md sidecar from a repo-tracked body
#      file (e.g. scientia-conflict-resolver/SKILL.md). Omit for the init-authored
#      implementer/reviewer/integrator personas.
...
# only model.default is reconciled. Re-running is safe.
#
# Usage:
#   provision_profile.sh <name> <full-model-id> [body.md] [description]
# Example:
#   provision_profile.sh scientia-conflict-resolver \
#     accounts/fireworks/models/deepseek-v4-pro \
#     scientia-conflict-resolver/SKILL.md "Integrate-time conflict backstop…"
set -euo pipefail
