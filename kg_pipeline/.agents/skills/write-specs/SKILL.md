...
- Use `### Scenario: <title>` headings inside the rendered `## Scenarios`
  section; `kg_pipeline.validators.validate_specs` checks the one-When rule.
