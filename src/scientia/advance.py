"""scientia.advance — the package-owned stage-advance gate (ADR-0006).

``scientia`` (the orchestrator) is an LLM ``SKILL.md`` and could, in principle, skip a
...
from scientia import paths, validators
