"""scientia.validators — deterministic artifact validators (ADR-0007).
...
guardrail the controller gates on: :mod:`scientia.advance` writes a stage's
...
def validate_specs(specs_dir: Path) -> list[str]:
    ...
    for spec in spec_files:
        ...
        # One observable When per scenario (scientia-write-specs discipline / gherkin).
